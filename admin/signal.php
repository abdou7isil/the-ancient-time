...
echo $total_count;
  ...
  $sql = "select signal_.id_rapport,sprobleme.nom,date_send from rapport join signal_ on rapport.id_rapport=signal_.id_rapport join sprobleme on sprobleme.id_sprobleme=signal_.id_sprobleme order by date_send DESC ";
                      ...
                      <tr>
                       <td><?php echo h($row['nom']); ?></td>
                        ...
                        <td class="text-center  text-light">
                          <a href="signalConsulter.php?id=<?php echo ($row['id_rapport']);?>" name="button" class="btn btn-primary" >Consulter</a>
