      ...
      <div class="row">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top  top-navbar">
          ...
          <ul class="navbar-nav flex-column mt-4 ">
            ...
            <li class="nav-item"><a href="mondes.php" class="nav-link text-white p-3 mb-2 sidebar-link text-danger">
            ...
            <li class="nav-item"><a href="magasin.php" class="nav-link text-white p-3 mb-2 sidebar-link">
              <i class="fas fa-donate text-light fa-lg mr-3"></i>Magasin</a></li>
