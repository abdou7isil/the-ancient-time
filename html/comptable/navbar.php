      ...
      <div class="row">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top  top-navbar">
          ...
          <ul class="navbar-nav flex-column mt-4 ">
            ...
            <li class="nav-item"><a href="documentation.php" class="nav-link text-danger p-3 mb-2 sidebar-link">
              <i class="fas fa-file-alt text-danger fa-lg mr-3"></i>Documentation!</a></li>
